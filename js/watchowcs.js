      ...
      <section class="card faq-card" id="watchowcs-fun">
        ...
        ${siteText_(
          ...
          `
            ...
            <p>
              気になる試合は冒頭から見るのがおすすめです。
              キャスターさんが観戦に必要な基本を毎回解説しています。
            </p>
