...
const OWCS_FLOW_COPY_JP_ = {
  ...
  faceitInfoBody:
    "2部リーグのような位置付けで、OWCSと同時進行されています。<br>OWCS同様、シーズン毎に各階級の総当たり戦→トーナメント戦が行われています。<br>※アジア地域にはありません。<br>※公式配信はMasterプレイオフ最終日以外ありません。<br>公式XやLiquipedia等で試合日程を確認し、試合当日に選手の個人配信や FACEIT キャスター配信があれば、視聴可能です。",
  naMain: "OWCS NA",
  emeaMain: "OWCS EMEA",
